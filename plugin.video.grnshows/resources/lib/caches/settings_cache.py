...
class SettingsCache:
	def get(self, setting_id):
		try:
			...
			setting_id = setting_id.replace('grnshows.', '')
	...
	def set_memory_cache(self, setting_id, setting_value):
		kodi_utils.set_property('grnshows.%s' % setting_id, setting_value)

	def delete_memory_cache(self, setting_id):
		clear_property('grnshows.%s' % setting_id)
...
def set_boolean(params):
	...
	set_setting(setting, boolean_dict[get_setting('grnshows.%s' % setting)])

def set_string(params):
	current_value = get_setting('grnshows.%s' % params['setting_id'])
...
def set_path(params):
	...
	new_value = kodi_utils.kodi_dialog().browse(browse_mode, '', '', defaultt=get_setting('grnshows.%s' % setting_id))
	set_setting(setting_id, new_value)
...
def set_source_folder_path(params):
	setting_id = params['setting_id']
	current_setting = get_setting('grnshows.%s' % setting_id)
...
def default_setting_values(setting_id):
	if 'grnshows.' in setting_id: setting_id = setting_id.replace('grnshows.', '')
	d_settings = default_settings()
...
#===============================================================================#
#==================== General
{'setting_id': 'auto_start_grnshows', 'setting_type': 'boolean', 'setting_default': 'false'},
{'setting_id': 'addon_icon_choice', 'setting_type': 'string', 'setting_default': 'resources/media/addon_icons/grnshows_icon_01.png'},
...
{'setting_id': 'update.username', 'setting_type': 'string', 'setting_default': 'GRN-Shows'},
{'setting_id': 'update.location', 'setting_type': 'string', 'setting_default': 'grn-shows'},
#==================== Watched Indicators
{'setting_id': 'watched_indicators', 'setting_type': 'action', 'setting_default': '0', 'settings_options': {'0': 'GRN Shows', '1': 'Trakt'}},
#======+============= Trakt Cache
...
#==================== Downloads
{'setting_id': 'movie_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.grnshows/Movies Downloads/', 'browse_mode': '0'},
{'setting_id': 'tvshow_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.grnshows/TV Show Downloads/', 'browse_mode': '0'},
{'setting_id': 'premium_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.grnshows/Premium Downloads/', 'browse_mode': '0'},
{'setting_id': 'image_download_directory', 'setting_type': 'path', 'setting_default': 'special://profile/addon_data/plugin.video.grnshows/Image Downloads/', 'browse_mode': '0'},
...
{'setting_id': 'trakt.client', 'setting_type': 'string', 'setting_default': '@@TRAKT_CLIENT_ID@@'},
{'setting_id': 'trakt.secret', 'setting_type': 'string', 'setting_default': '@@TRAKT_CLIENT_SECRET@@'},
#==================== TMDb API
{'setting_id': 'tmdb_api', 'setting_type': 'string', 'setting_default': '@@TMDB_API_KEY@@'},
#==================== TMDb Lists
...
{'setting_id': 'addon_icon_choice_name', 'setting_type': 'string', 'setting_default': 'grnshows_icon_01.png'},
