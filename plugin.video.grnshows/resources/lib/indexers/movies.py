...
class Movies:
	...
	def fetch_list(self):
		...
		try:
			...
			if page_no == 1 and not self.is_external: kodi_utils.set_property('grnshows.exit_params', kodi_utils.folder_path())
	...
	def build_movie_content(self, _position, _id):
		try:
			...
			set_properties({
				...
				'grnshows.extras_params': extras_params,
				'grnshows.options_params': options_params,
				'grnshows.playback_options_params': playback_options_params,
				'grnshows.browse_movie_set_params': browse_movie_set_params,
				'grnshows.browse_recommended_params': browse_recommended_params,
				'grnshows.browse_related_params': browse_related_params,
				'grnshows.browse_more_like_this_params': browse_more_like_this_params,
				'grnshows.browse_similar_params': browse_similar_params,
				'grnshows.browse_in_trakt_list_params': browse_in_trakt_list_params,
				'grnshows.trakt_manager_params': trakt_manager_params,
				'grnshows.personal_manager_params': personal_manager_params,
				'grnshows.tmdb_manager_params': tmdb_manager_params,
				'grnshows.favorites_manager_params': favorites_manager_params
				})
